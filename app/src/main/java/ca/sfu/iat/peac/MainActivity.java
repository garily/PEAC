...
//        fragmentManager
//                .beginTransaction()
//                .replace(fragmentId, new MuseConnectFragment())
//                .commit();
    }
    ...
    private void initUI() {
        ...
        connectButton.setOnClickListener(MainActivity.this);
        Button disconnectButton = (Button) findViewById(R.id.disconnect);
        disconnectButton.setOnClickListener(MainActivity.this);
        Button pauseButton = (Button) findViewById(R.id.pause);
        pauseButton.setOnClickListener(MainActivity.this);

        spinnerAdapter = new ArrayAdapter<String>(MainActivity.this, android.R.layout.simple_spinner_item);
        Spinner musesSpinner = (Spinner) findViewById(R.id.muses_spinner);
